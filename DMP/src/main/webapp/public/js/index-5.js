...
/*	$('.color_k1 img').eq(0).click(function(){
	...
	$('.kj').click(function(){
		$(this).toggleClass('kjclick');
	});
	
	
	$('.xz2,.fb').hide();
	$('.cxfb').click(function(){
		$(this).parent().children().show().eq(0).hide();
		$(this).parent().children('.cxfb').hide();
		$(this).parents("tr").find(".fbzt").toggleClass("fbztclick");
	});
	$('.fb').click(function(){
		$(this).parent().children().show().eq(1).hide();
		$(this).parent().children('.fb').hide();
		$(this).parents("tr").find(".fbzt").toggleClass("fbztclick");
	});
